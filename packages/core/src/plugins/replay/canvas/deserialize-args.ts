...
import { TCanvasArg, TSerializedCanvasArg } from '../../../types';

import { TImageMap } from './types';
...
export function isSerializedArg(arg: unknown): arg is TSerializedCanvasArg {
...
): (arg: TCanvasArg) => Promise<any> {
  return async (arg: TCanvasArg): Promise<any> => {
